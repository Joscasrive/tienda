<div>
    <div class="w-full h-screen bg-gradient-to-r from-rose-200 to-rose-500 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
          <!-- Grid -->
          <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
            <div>
              <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Comience su viaje con <span class="text-yellow-600">TinaColors</span></h1>
              <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">Compre una amplia variedad de productos de manera rapida y sencilla usando nuestra tienda online.
            </p>
      ...
      <section class="py-20">
        <div class="max-w-xl mx-auto">
          <div class="text-center ">
            <div class="relative flex flex-col items-center">
              <h1 class="text-5xl font-bold dark:text-gray-200"><span class="text-blue-500"> Marcas
                </span> </h1>
        ...
        <div class="justify-center max-w-6xl px-4 py-4 mx-auto lg:py-0" wire:key="{{$brand->id}}">
          <div class="grid grid-cols-1 gap-6 lg:grid-cols-4 md:grid-cols-2">
      
            <div class="bg-white rounded-lg shadow-md dark:bg-gray-800">
              <a href="" class="">
                <img src="{{Storage::url($brand->image)}}" alt="{{$brand->name}}" class="object-cover w-full h-64 rounded-t-lg">
              </a>
      ...
      <div class="bg-rose-300 py-20">
        <div class="max-w-xl mx-auto">
          <div class="text-center ">
            <div class="relative flex flex-col items-center">
              <h1 class="text-5xl font-bold dark:text-gray-200"> <span class="text-blue-500"> Categorias
                </span> </h1>
              <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
                <div class="flex-1 h-2 bg-blue-200">
                </div>
              ...
              <div class="p-4 md:p-5">
                <div class="flex justify-between items-center">
                  <div class="flex items-center">
                    <img class="h-[2.375rem] w-[2.375rem] rounded-full" src="{{Storage::url($category->image)}}" alt="{{$category->image}}">
                    <div class="ms-3">
       ...
       <section class="py-14 font-poppins dark:bg-gray-800">
        <div class="max-w-6xl px-4 py-6 mx-auto lg:py-4 md:px-6">
          <div class="max-w-xl mx-auto">
            <div class="text-center ">
              <div class="relative flex flex-col items-center">
                <h1 class="text-5xl font-bold dark:text-gray-200"> Clientes <span class="text-blue-500"> Reseña
                  </span> </h1>
                <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
                  <div class="flex-1 h-2 bg-blue-200">
                  </div>
